...
export const createsubCategory = async (req, res) => {
  uploadFiles(req, res, async (err) => {
    ...
    try {
      ...
      console.log("Category Data before save:", categoryData);

      // if (!categoryData.url_Slug) {
      //   return res.status(400).json({ message: "URL slug is required" });
      // }

      // const existingCategory = await SubCategory.findOne({ url_Slug: categoryData.url_Slug });
      // if (existingCategory) {
